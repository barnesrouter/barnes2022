            ...
            <div id="lm" className="accordion__section flex-md">
                <div className="menu-content">
                    ...
                    <ContextAwareToggle eventKey="2">
                        <h4>Composting<span><Arrow /></span></h4>
                        <div className="menu-image"><div></div></div>
                    </ContextAwareToggle>
                    
                    <Accordion.Collapse className="accordion__content" eventKey="2">
                        <ul>
                            <li><Link to="/composting/landscape-materials">Landscape Materials</Link></li>
                            <li><Link to="/composting/oberlin">City of Oberlin</Link></li>
                        </ul>
                    </Accordion.Collapse>
                </div>
